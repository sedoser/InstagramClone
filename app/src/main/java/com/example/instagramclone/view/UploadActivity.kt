...
class UploadActivity : AppCompatActivity() {
    ...
    fun upload (view : View){
        ...
        val imageReference = reference.child("images/$imageID")
        ...
        if (selectedPicture != null){
            imageReference.putFile(selectedPicture!!).addOnSuccessListener {
                ...
                profilePictureReference.downloadUrl.addOnSuccessListener {
                    ...
                    postMap.put("profilePictureUrl", profilePictureUrl)
                }
                val uploadPictureReference = storage.reference.child("images/$imageID")
